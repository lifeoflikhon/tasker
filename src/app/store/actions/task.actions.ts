...
export const getPastTasks = createAction(GET_PAST_TASKS);
export const getTodayTasks = createAction(GET_TODAY_TASKS);
export const getUpcomingTasks = createAction(GET_UPCOMING_TASKS);
